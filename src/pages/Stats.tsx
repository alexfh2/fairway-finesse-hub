...
const Stats = () => {
  ...
  const statCards = stats
    ? [
        ...
        { icon: CircleDot, label: t('stats.hardestHole', 'Hoyo más difícil'), value: `${stats.hardestHole.value}`, detail: `${stats.hardestHole.name} — ${stats.hardestHole.detail || ''}`, unit: 'golpes' },
        { icon: CircleDot, label: t('stats.easiestHole', 'Hoyo más fácil'), value: `${stats.easiestHole.value}`, detail: `${stats.easiestHole.name} — ${stats.easiestHole.detail || ''}`, unit: 'golpes' },
